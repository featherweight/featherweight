...
<Project Type="Project" LVVersion="12008004">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="ftw-master" Type="Folder">
			<Item Name="Actor" Type="Folder">
				<Item Name="ZMQ" Type="Folder">
					<Item Name="FTW-Endpoint-ZMQ.lvclass" Type="LVClass" URL="../Actor/ZMQ/FTW-Endpoint-ZMQ.lvclass"/>
					<Item Name="FTW-ZMQ-Win32.dll" Type="Document" URL="../Actor/ZMQ/FTW-ZMQ-Win32.dll"/>
					<Item Name="libzmq32.dll" Type="Document" URL="../Actor/ZMQ/libzmq32.dll"/>
				</Item>
				<Item Name="FTW-Actor.lvlib" Type="Library" URL="../Actor/FTW-Actor.lvlib"/>
			</Item>
			<Item Name="Core" Type="Folder">
				...
				<Item Name="Collection" Type="Folder">
					<Item Name="FTW-Collection-KeyValuePair.ctl" Type="VI" URL="../Core/Collection/FTW-Collection-KeyValuePair.ctl"/>
				</Item>
				...
				<Item Name="Error" Type="Folder">
					<Item Name="FTW-ERR-AbstractMethodCall.vi" Type="VI" URL="../Core/Error/FTW-ERR-AbstractMethodCall.vi"/>
				...
				<Item Name="File" Type="Folder">
					...
					<Item Name="FTW-File-DereferenceNamespace.vi" Type="VI" URL="../Core/File/FTW-File-DereferenceNamespace.vi"/>
				...
				<Item Name="JSON" Type="Folder">
					<Item Name="FTW-JSON-Array-Deserialize.vi" Type="VI" URL="../Core/JSON/FTW-JSON-Array-Deserialize.vi"/>
					<Item Name="FTW-JSON-Array-Serialize.vi" Type="VI" URL="../Core/JSON/FTW-JSON-Array-Serialize.vi"/>
					...
					<Item Name="FTW-JSON-Interpret-Array-String.vi" Type="VI" URL="../Core/JSON/FTW-JSON-Interpret-Array-String.vi"/>
					<Item Name="FTW-JSON-Interpret-Boolean.vi" Type="VI" URL="../Core/JSON/FTW-JSON-Interpret-Boolean.vi"/>
					<Item Name="FTW-JSON-Interpret-String.vi" Type="VI" URL="../Core/JSON/FTW-JSON-Interpret-String.vi"/>
					<Item Name="FTW-JSON-Minify.vi" Type="VI" URL="../Core/JSON/FTW-JSON-Minify.vi"/>
					...
					<Item Name="FTW-JSON-Validation.ctl" Type="VI" URL="../Core/JSON/FTW-JSON-Validation.ctl"/>
				</Item>
				<Item Name="Numeric" Type="Folder">
					<Item Name="FTW-NUM-Counter.vi" Type="VI" URL="../Core/Numeric/FTW-NUM-Counter.vi"/>
					<Item Name="FTW-NUM-EnumItems.vi" Type="VI" URL="../Core/Numeric/FTW-NUM-EnumItems.vi"/>
				...
				<Item Name="VI Server" Type="Folder">
					<Item Name="FTW-VIServer-AsyncCallOptions.vi" Type="VI" URL="../Core/VI Server/FTW-VIServer-AsyncCallOptions.vi"/>
					<Item Name="FTW-VIServer-GetClassDefaultData.vi" Type="VI" URL="../Core/VI Server/FTW-VIServer-GetClassDefaultData.vi"/>
					<Item Name="FTW-VIServer-LabVIEWinfo.vi" Type="VI" URL="../Core/VI Server/FTW-VIServer-LabVIEWinfo.vi"/>
					<Item Name="FTW-VIServer-OSinfo.vi" Type="VI" URL="../Core/VI Server/FTW-VIServer-OSinfo.vi"/>
					<Item Name="FTW-VIServer-VI-Metadata.vi" Type="VI" URL="../Core/VI Server/FTW-VIServer-VI-Metadata.vi"/>
				</Item>
				<Item Name="XML" Type="Folder">
					...
					<Item Name="FTW-XML-Element-Add.vi" Type="VI" URL="../Core/XML/FTW-XML-Element-Add.vi"/>
					...
					<Item Name="FTW-XML-Query-ElementXML.vi" Type="VI" URL="../Core/XML/FTW-XML-Query-ElementXML.vi"/>
					...
					<Item Name="FTW-XML-ValidateTagName.vi" Type="VI" URL="../Core/XML/FTW-XML-ValidateTagName.vi"/>
					<Item Name="FTW-XML.lvclass" Type="LVClass" URL="../Core/XML/FTW-XML.lvclass"/>
				</Item>
			</Item>
			...
			<Item Name="Security" Type="Folder">
				<Item Name="Encryption" Type="Folder">
					<Item Name="FTW-Crypto-AES256.vi" Type="VI" URL="../Security/Encryption/FTW-Crypto-AES256.vi"/>
					<Item Name="FTW-Crypto-FileHash.vi" Type="VI" URL="../Security/Encryption/FTW-Crypto-FileHash.vi"/>
					<Item Name="FTW-Crypto-HMAC-Hasher.vi" Type="VI" URL="../Security/Encryption/FTW-Crypto-HMAC-Hasher.vi"/>
					<Item Name="FTW-Crypto-PublicKeySignature-GenerateKeys.vi" Type="VI" URL="../Security/Encryption/FTW-Crypto-PublicKeySignature-GenerateKeys.vi"/>
					<Item Name="FTW-Crypto-PublicKeySignature-Sign.vi" Type="VI" URL="../Security/Encryption/FTW-Crypto-PublicKeySignature-Sign.vi"/>
					<Item Name="FTW-Crypto-PublicKeySignature-Verify.vi" Type="VI" URL="../Security/Encryption/FTW-Crypto-PublicKeySignature-Verify.vi"/>
					<Item Name="FTW-Crypto-String-Sign.vi" Type="VI" URL="../Security/Encryption/FTW-Crypto-String-Sign.vi"/>
					<Item Name="FTW-Crypto-String-Verify.vi" Type="VI" URL="../Security/Encryption/FTW-Crypto-String-Verify.vi"/>
				</Item>
			</Item>
			<Item Name="UI" Type="Folder">
				<Item Name="FileSystem" Type="Folder">
					<Item Name="FTW-FileSystem-FileVersion.vi" Type="VI" URL="../UI/FileSystem/FTW-FileSystem-FileVersion.vi"/>
					<Item Name="FTW-FileSystem-GetShellIcon.vi" Type="VI" URL="../UI/FileSystem/FTW-FileSystem-GetShellIcon.vi"/>
					...
					<Item Name="FTW-FileSystem-PathToURI.vi" Type="VI" URL="../UI/FileSystem/FTW-FileSystem-PathToURI.vi"/>
				</Item>
			...
			<Item Name="Web" Type="Folder">
				<Item Name="HTTP Client" Type="Folder">
					<Item Name="FTW-HTTPClient.lvclass" Type="LVClass" URL="../Web/HTTP Client/FTW-HTTPClient.lvclass"/>
				</Item>
				<Item Name="Transfer Client" Type="Folder">
					<Item Name="dotNET" Type="Folder">
						<Item Name="FTW-TransferClient-dotNET.lvclass" Type="LVClass" URL="../Web/Transfer Client/dotNET/FTW-TransferClient-dotNET.lvclass"/>
					</Item>
					<Item Name="S3" Type="Folder">
						<Item Name="FTW-TransferClient-S3.lvclass" Type="LVClass" URL="../Web/Transfer Client/S3/FTW-TransferClient-S3.lvclass"/>
					</Item>
					<Item Name="FTW-TransferClient-TransferProgress.ctl" Type="VI" URL="../Web/Transfer Client/FTW-TransferClient-TransferProgress.ctl"/>
					<Item Name="FTW-TransferClient-TransferStatus.ctl" Type="VI" URL="../Web/Transfer Client/FTW-TransferClient-TransferStatus.ctl"/>
					<Item Name="FTW-TransferClient.lvclass" Type="LVClass" URL="../Web/Transfer Client/FTW-TransferClient.lvclass"/>
				</Item>
				<Item Name="Utils" Type="Folder">
					<Item Name="FTW-Web-EmailAddressValidator.vi" Type="VI" URL="../Web/Utils/FTW-Web-EmailAddressValidator.vi"/>
					<Item Name="FTW-Web-EscapeURL.vi" Type="VI" URL="../Web/Utils/FTW-Web-EscapeURL.vi"/>
					<Item Name="FTW-Web-HTTPResponseCode.ctl" Type="VI" URL="../Web/Utils/FTW-Web-HTTPResponseCode.ctl"/>
					<Item Name="FTW-Web-JoinURIs.vi" Type="VI" URL="../Web/Utils/FTW-Web-JoinURIs.vi"/>
					<Item Name="FTW-Web-MIMEtype.ctl" Type="VI" URL="../Web/Utils/FTW-Web-MIMEtype.ctl"/>
					<Item Name="FTW-Web-ParseResponseHeaders.vi" Type="VI" URL="../Web/Utils/FTW-Web-ParseResponseHeaders.vi"/>
					<Item Name="FTW-Web-UTF8.vi" Type="VI" URL="../Web/Utils/FTW-Web-UTF8.vi"/>
					<Item Name="FTW-Web-UTF16.vi" Type="VI" URL="../Web/Utils/FTW-Web-UTF16.vi"/>
				</Item>
			</Item>
		</Item>
